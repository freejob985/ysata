...
class adv extends Controller
{
    ...
    public function adv($adv, Request $request)
    {
        ...
        SEOMeta::setTitle(__('seo.backend.backend.item.create-item', ['site_name' => empty($settings->setting_site_name) ? config('app.name', 'Laravel') : $settings->setting_site_name]));
        ...
        return response()->view('backend.user.item.adv',
    ...
    public function msg(Request $request){
        ...
        SEOMeta::setTitle(__('seo.backend.backend.message.messages', ['site_name' => empty($settings->setting_site_name) ? config('app.name', 'Laravel') : $settings->setting_site_name]));
        SEOMeta::setDescription('');
        SEOMeta::setCanonical(URL::current());
        SEOMeta::addKeyword($settings->setting_site_seo_home_keywords);
        /**
        ...
        return view('backend.user.item.msg', compact('all_users', 'user_id', 'threads','Invitations'));
    }
